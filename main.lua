...
if not love.filesystem.getInfo("Drives/C/DiskOS", "directory") then
  print("Clonando sistema base a Drives/C/")
  copyDir("C", "Drives/C")
end

if not love.filesystem.getInfo("Drives/D/game.lk12") and love.filesystem.getInfo("game.lk12") then
  print("Copiando cartucho a Drives/D/")
  love.filesystem.createDirectory("Drives/D")
  local data = love.filesystem.read("game.lk12")
  love.filesystem.write("Drives/D/game.lk12", data)
end
